    ...
    <?php if( have_rows('list') ): ?>
        ...
        <?php while( have_rows('list') ): the_row(); ?>
            <div class="col-span-2 md:col-span-1 flex flex-col gap-1 md:gap-2">
                ...
                <h2 class="text-25 leading-35 md:text-30 md:leading-40 font-medium md:font-normal text-darkblue md:w-[80%]"><?php the_sub_field('title') ?></h2>
                <div class="mt-auto">
    ...
    <article class="relative h-fit w-full bg-gradient-grey">
        <div class="container flex flex-col justify-center bg-grey py-10 ">
            <div class="md:w-[70%] mx-auto flex flex-col gap-3">
                <h2 class="text-40 leading-50 md:text-50 md:leading-70 font-normal text-darkblue  text-center md:text-start"><?php the_field('title_call'); ?></h2>
