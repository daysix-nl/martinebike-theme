<section class="mobile:h-[80vh] h-[30vh] md:h-[55vh] w-screen relative overflow-hidden bg-white">
    <img class="w-full h-full object-cover absolute top-0 right-0  image-full" src="<?php echo get_field('image'); ?>" alt="">
    <div class="container flex flex-col justify-center gap-3 z-2 h-full relative z-[2]">
        <h1 class=" text-white leading-35 text-35 md:leading-70 md:text-65 font-medium animation-title "><?php echo get_field('title'); ?></h1>
    </div>
