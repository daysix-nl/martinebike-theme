<section class="h-screen w-screen relative ">
    ...
    <div class="container relative z-[2] h-full justify-center flex flex-col">
        ...
        <div class=" flex-row flex-wrap gap-2 md:gap-2 gap-y-2  flex h-fit"> 
            <a class="flex flex-row h-5  justify-center items-center bg-white py-1 px-3 rounded-full text-darkblue w-fit" href="<?php the_field('button_link_1');?>"><?php the_field('button_tekst_1');?></a>
            <a class="flex flex-row h-5  justify-center items-center bg-white py-1 px-3 rounded-full text-darkblue w-fit" href="<?php the_field('button_link_2');?>"><?php the_field('button_tekst_2');?></a>
            <a class="flex flex-row h-5  justify-center items-center bg-white py-1 px-3 rounded-full text-darkblue w-fit" href="<?php the_field('button_link_3');?>"><?php the_field('button_tekst_3');?></a>
            <!-- <button class="flex flex-row h-5  justify-center items-center bg-white py-1 px-3 rounded-full text-darkblue w-fit button-contact-overlay"><?php the_field('button_tekst_3');?></button> -->
        </div>
    </div>
