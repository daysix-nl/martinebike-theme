    ...
    <article class="relative h-fit w-full bg-gradient-grey">
        <div class="container flex flex-col justify-center bg-grey py-10 ">
            <div class="md:w-[70%] mx-auto flex flex-col gap-3">
                <h2 class="text-40 leading-50 md:text-50 md:leading-70 font-normal text-darkblue  text-center md:text-start"><?php the_field('title'); ?></h2>
                ...
                <?php 
                    ...
                    if( $link ): 
                        ...
                        ?>
                        <a class="flex flex-row gap-1 justify-center items-center bg-darkblue py-1 px-3 rounded-full text-white mx-auto md:mx-[unset] w-fit" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </article>
