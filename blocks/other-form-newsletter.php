<section class="my-8 md:my-10 relative bg-white">
    <div class="container flex justify-center items-center flex-col">
        <h3 class="mb-3 text-25 leading-35 md:text-30 md:leading-40  font-medium md:font-normal text-oranje text-center mx-auto"><?php echo get_field('title_maandelijkse_nieuwsbrief', 'option'); ?></h3>
