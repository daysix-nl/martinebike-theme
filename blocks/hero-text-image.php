<section class="h-[70vh] w-screen relative md:mt-5">
    ...
    <div class="container grid grid-cols-2 z-2 relative">
        <div class="col-span-2 md:col-span-1 flex flex-col justify-center h-[70vh]">
            ...
            <h1 class="text-35 leading-42 md:text-50 md:leading-60 font-medium md:font-normal text-white md:text-darkblue md:w-[90%]"><?php the_field('title'); ?></h1>
        </div>
    </div>
</section>