        ...
        <div class="col-span-1">
            ...
            <p class="text-black text-16 leading-26 font-normal pt-3">INSPECTION OFF:</p>
             <ul class="flex flex-col gap-1 list-inside pt-3">
                ...
                <li class="text-black text-16 leading-26 font-normal">BRAKE system</li>
                <li class="text-black text-16 leading-26 font-normal">ELECTRONIC system</li>
                <li class="text-black text-16 leading-26 font-normal">ENGINE</li>
                <li class="text-black text-16 leading-26 font-normal">WHEELS/TYRES</li>
                <li class="text-black text-16 leading-26 font-normal">TEST DRIVE & BIKE FIT</li>
                <li class="text-black text-16 leading-26 font-normal">PEDALS</li>
                <li class="text-black text-16 leading-26 font-normal">BOTTOM BRACKET</li>
                <li class="text-black text-16 leading-26 font-normal">HEADSET</li>
                <li class="text-black text-16 leading-26 font-normal">WHEELHUB</li>
                <li class="text-black text-16 leading-26 font-normal">LIGHTS</li>
                <li class="text-black text-16 leading-26 font-normal">E-SOFTWARE UPDATE</li>
            </ul>
             <p class="text-black text-16 leading-26 font-normal pt-3">+ PICKUP/DELIVERY COST</p>
        </div>
        <div class="col-span-1">
            ...
            <p class="text-black text-16 leading-26 font-normal pt-3">= CLASSIC +</p>
             <ul class="flex flex-col gap-1 list-inside pt-3">
                ...
                <li class="text-black text-16 leading-26 font-normal">FREE RENTAL E-BIKE DURING SERVICE</li>
                <li class="text-black text-16 leading-26 font-normal">NO CHARGE FOR SMALL PARTS (<10 EURO)</li>
                <li class="text-black text-16 leading-26 font-normal">2 FREE GUIDED TOURS</li>
                <li class="text-black text-16 leading-26 font-normal">FIRST TO KNOW ON ANY SPECIAL OFFERS</li>
            </ul>
        </div>
        <div class="col-span-1">
            ...
            <p class="text-black text-16 leading-26 font-normal pt-3">= EXECUTIVE +</p>
             <ul class="flex flex-col gap-1 list-inside pt-3">
                ...
                <li class="text-black text-16 leading-26 font-normal">ALL PARTS THAT NEED TO BE REPLACED FREE OF CHARGE*</li>
            </ul>
             <p class="text-black text-16 leading-26 font-normal pt-3">EXCEPT* : BATTERY, <br>INTENTIONAL DAMAGE, THIRD PARTY DAMAGE <br>MAX 1000 EURO PER EVENT AND MAX 5YR</p>
        </div>
