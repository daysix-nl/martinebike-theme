        ...
        <div class="col-span-2 md:col-span-1 <?php echo (get_field('list_sticky') ? "md:h-screen md:sticky md:top-0" : ""); ?> ">
            <div class="w-full h-full relative scroll-list <?php echo (get_field('list_sticky') ? "md:pt-10" : ""); ?> ">
                <?php if(get_field('title')): ?>
                    <h3 class="text-black text-30 leading-40 font-bold mb-2 md:mb-3 "><?php the_field('title'); ?></h3>
                <?php endif; ?>
                ...
                <?php if( have_rows('list') ): ?>
                    <?php while( have_rows('list') ): the_row();  ?>
                        <div class=" animation-<?php the_sub_field('name'); ?>">
                            ...
                            <div class="swiper mySwiperAnimation mt-2 hidden md:block">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide w-full">
                                            <img class="w-auto h-[250px] mr-auto mb-2" src="<?php the_sub_field('image');?>" alt="img">
                                        </div>
                                    <?php endwhile; ?>
                                </div>
            ...
            <?php if( have_rows('list') ): ?>
                ...
                <?php while( have_rows('list') ): the_row();  ?>
                    <li class="mx-auto col-span-1">
                        ...
                        if( !empty( $image ) ): ?>
                           <div id="<?php the_sub_field('name'); ?>" class="h-[170px] flex justify-center items-center scroll-list-div">
