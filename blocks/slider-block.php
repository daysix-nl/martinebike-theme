    ...
    <div class="container">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="col-span-2 md:col-span-1 md:pr-6">
                                    <?php if(get_sub_field('name')): ?>
                                        <h3 class="text-25 leading-35 md:text-30 md:leading-40 font-medium md:font-normal text-darkblue md:w-[90%]"><?php the_sub_field('name'); ?></h3>
                                    <?php endif; ?>
                                </div>
        ...
        <?php if( have_rows('slider-tabs-repeater') ): ?>
            <div thumbsSlider="" class="swiper mySwiper">
                    ...
                    <?php while( have_rows('slider-tabs-repeater') ): the_row(); ?>
                        <div class="swiper-slide bg-darkblue clip-path-tabs h-[50px] last-of-type:border-r-0 border-r-2 border-white">
