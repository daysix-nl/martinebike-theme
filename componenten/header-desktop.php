...
<div id="navbar-desktop" class="nav hidden lg:flex text-wit px-4 py-2 justify-between items-center ">
    ...
    <nav class="menu items-center gap-4 flex z-50">
        ...
        <?php if(get_field('name_contact', 'option')): ?>
            <a class="ml-auto mt-auto button-contact" href="<?php the_field('url_contact', 'option'); ?>"><div class="border clip-path-button h-[50px]"><span class="outer bg-white text-white px-3 text-16 leading-24 font-medium h-[50px] flex items-center "><?php the_field('name_contact', 'option'); ?></span></div></a>
        <?php endif; ?>
    </nav>
</div>
